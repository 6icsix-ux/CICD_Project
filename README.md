...
5. ทำการแก้ไขชื่อ Database และ Password ให้เข้าไปที่ finalpj - settings.py เลื่อนลงมาจนถึง DATABASES แก้ไข 'USER' และ 'Password' โดยใช้จากที่ทำการติดตั้ง Mysql ![image](https://github.com/user-attachments/assets/8cf75df5-10d5-4233-aecd-48546d2226a1)
